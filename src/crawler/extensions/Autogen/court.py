...
texas_lawyer = autogen.AssistantAgent(
    ...
    You need to provide some verified policies, laws that are pass by Texas Government in order to implement Title IX. You need to continuously defend and interact with CaliforniaLawyer and Admin.
""",
)
...
california_lawyer = autogen.AssistantAgent(
    ...
    You need to provide some verified policies, laws that are pass by California Government in order to implement Title IX. You need to continuously defend and interact with TexasLawyer and Admin.
""",
)
...
groupchat = autogen.GroupChat(
    ...
    agents=[user_proxy, texas_lawyer, california_lawyer], messages=[], max_round=5
)
